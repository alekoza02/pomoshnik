...
class Costruttore:
    ...
    def costruisci_main_plot(self):
        ...
        s.context_menu["item1"].add_element("w_plot_area", Entrata("75%w", "220px", "lu", "20%w", "30px", text="0.8", title="larghezza plot area", lunghezza_max=5, solo_numeri=True, num_valore_minimo=0.001, num_valore_massimo=0.999, tooltip="Indica la larghezza massima occupata dal grafico. \\i{\\#aaffaa{Min: 0} | \\#ffaaaa{Max: 1} | Std: 0.8}\n\\#777777{La larghezza massima è riferita alla dimensione del lato del quadrato massimo inscritto dentro alla zona di disegno.}"), window="wind1")
        ...
        s.context_menu["item1"].add_element("x_plot_area", Entrata("75%w", "305px", "lu", "20%w", "30px", text="0.15", title="X plot area", lunghezza_max=5, solo_numeri=True, num_valore_minimo=0.001, num_valore_massimo=0.999, tooltip="Indica la posizione X del lato superiore dal grafico. \\i{\\#aaffaa{Min: 0} | \\#ffaaaa{Max: 1} | Std: 0.1}\n\\#777777{La posizione X massima è riferita alla dimensione del lato del quadrato massimo inscritto dentro alla zona di disegno.}"), window="wind1")
        ...
        s.context_menu["item2"].add_element("function_size", Entrata("75%w", "450px", "lu", "10%w", "30px", text="1", title="size", lunghezza_max=3, solo_numeri=True, num_valore_minimo=1, num_valore_massimo=32, tooltip="Imposta la dimensione del tratto. \\i{\\#aaffaa{Min: 0} | \\#ffaaaa{Max: 32} | Std: 1}"), window="wind2")
        ...
        s.context_menu["item2"].add_element("scatter_toggle", Bottone_Toggle("40%w", "225px", "ru", "30px", "30px", text="Toggle scatter", type_checkbox=True, text_on_right=False, state=True, tooltip="Abilita la visualizzazione dei pallini nel plot attivo."), window="wind1")
        ...
        s.context_menu["item3"].add_element("text_title", Entrata("20%w", "100px", "lu", "75%w", "30px", text="\\i{Title} \\b{example}", title="Title", tooltip="Imposta il titolo del grafico.\n\\#777777{Il testo sarà sempre centrato, per ulteriori impostazioni cercare più in basso.}"), window="wind1")
        s.context_menu["item3"].add_element("text_label_x", Entrata("20%w", "150px", "lu", "75%w", "30px", text="\\#dc143c{\\lambda [cm\\^{-1}]}", title="Label X", tooltip="Imposta il label dell'asse X.\n\\#777777{Il testo sarà sempre centrato, per ulteriori impostazioni cercare più in basso.}"), window="wind1")
        s.context_menu["item3"].add_element("text_label_y", Entrata("20%w", "185px", "lu", "75%w", "30px", text="\\#aaffff{Intensity\\_{0} [#]}", title="Y", tooltip="Imposta il label dell'asse Y.\n\\#777777{Il testo sarà sempre centrato, per ulteriori impostazioni cercare più in basso.}"), window="wind1")
        s.context_menu["item3"].add_element("text_label_2y", Entrata("20%w", "220px", "lu", "75%w", "30px", text="2°Y axis", title="2°Y", tooltip="Imposta il label del secondo asse Y.\n\\#777777{Il testo sarà sempre centrato, per ulteriori impostazioni cercare più in basso.}"), window="wind1")
        
        s.context_menu["item3"].add_element("font_size_title", Entrata("75%w", "355px", "lu", "20%w", "30px", text="48", title="Title font size", lunghezza_max=3, solo_numeri=True, num_valore_minimo=8, num_valore_massimo=128, tooltip="Imposta la dimensione del carattere del label. \\i{\\#aaffaa{Min: 8} | \\#ffaaaa{Max: 128} | Std: 48}"), window="wind2")
        ...
        s.context_menu["item4"].add_element("second_y_axis", Bottone_Toggle("70%w", "140px", "cd", "35%w", "50px", False, False, "Toggle 2° Y axis", tooltip="Abilita la visualizzazione del secondo asse Y. Per i plot 2D abilita la barra di colore con i valori in Z.\n\\#777777{Per visualizzare un plot sul secondo asse, aggiungerlo nella sezione 'Impostazioni plot'}"), window="wind1")
        s.context_menu["item4"].add_element("invert_x_axis", Bottone_Toggle("30%w", "140px", "cd", "35%w", "50px", False, False, "Invert X axis", tooltip="Inverte la visualizzazione dell'asse X. Inverte sia la visualizzazione dei punti che il loro valore riportato."), window="wind1")

        s.context_menu["item4"].add_element("round_x", Entrata("75%w", "250px", "lu", "20%w", "30px", text="2", title="Round ticks X:", lunghezza_max=3, solo_numeri=True, num_valore_minimo=0, num_valore_massimo=12, tooltip="Imposta l'approssimazione dopo la virgola dei valori relativi all'asse X. \\i{\\#aaffaa{Min: 0} | \\#ffaaaa{Max: 12} | Std: 2}"), window="wind2")
        s.context_menu["item4"].add_element("round_y", Entrata("75%w", "285px", "lu", "20%w", "30px", text="2", title="Y:", lunghezza_max=3, solo_numeri=True, num_valore_minimo=0, num_valore_massimo=12, tooltip="Imposta l'approssimazione dopo la virgola dei valori relativi all'asse Y. \\i{\\#aaffaa{Min: 0} | \\#ffaaaa{Max: 12} | Std: 2}"), window="wind2")
        s.context_menu["item4"].add_element("round_2y", Entrata("75%w", "320px", "lu", "20%w", "30px", text="2", title="2°Y:", lunghezza_max=3, solo_numeri=True, num_valore_minimo=0, num_valore_massimo=12, tooltip="Imposta l'approssimazione dopo la virgola dei valori relativi al secondo asse Y. \\i{\\#aaffaa{Min: 0} | \\#ffaaaa{Max: 12} | Std: 2}"), window="wind2")
