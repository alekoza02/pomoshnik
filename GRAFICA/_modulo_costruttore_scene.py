...
class Costruttore:
    ...
    def costruisci_main_plot(self):
        ...
        s.context_menu["item4"].add_window("wind8", Collapsable_Window(w="98%w", h="180px", anchor=("lu ld (0px) (10px)", s.context_menu["item4"].windows["wind7"]), bg=[20, 20, 20], text="Tick spacing", closed=1))
        ...
        s.context_menu["item4"].add_element("ticks_bins_x", Entrata("75%w", "1620px", "lu", "20%w", "30px", text="7", title="Ticks bins X:", lunghezza_max=3, solo_numeri=True, num_valore_minimo=0, num_valore_massimo=25, tooltip="Imposta il numero desiderato di suddivisioni lungo l'asse X. \\i{\\#aaffaa{Min: 0} | \\#ffaaaa{Max: 25} | Std: 7}\n\\#777777{NOTA: Il valore indicato è un'indicazione. Il grafico non verrà suddiviso sempre esattamente con il valore indicato.}"), window="wind8")
        s.context_menu["item4"].add_element("ticks_bins_y", Entrata("75%w", "1655px", "lu", "20%w", "30px", text="5", title="Y:", lunghezza_max=3, solo_numeri=True, num_valore_minimo=0, num_valore_massimo=25, tooltip="Imposta il numero desiderato di suddivisioni lungo l'asse Y. \\i{\\#aaffaa{Min: 0} | \\#ffaaaa{Max: 25} | Std: 5}\n\\#777777{NOTA: Il valore indicato è un'indicazione. Il grafico non verrà suddiviso sempre esattamente con il valore indicato.}"), window="wind8")
        s.context_menu["item4"].add_element("ticks_bins_2y", Entrata("75%w", "1690px", "lu", "20%w", "30px", text="5", title="2°Y:", lunghezza_max=3, solo_numeri=True, num_valore_minimo=0, num_valore_massimo=25, tooltip="Imposta il numero desiderato di suddivisioni lungo il secondo asse Y. \\i{\\#aaffaa{Min: 0} | \\#ffaaaa{Max: 25} | Std: 5}\n\\#777777{NOTA: Il valore indicato è un'indicazione. Il grafico non verrà suddiviso sempre esattamente con il valore indicato.}"), window="wind8")
        # # ITEM 4 AXES ----------------------------------------------------
